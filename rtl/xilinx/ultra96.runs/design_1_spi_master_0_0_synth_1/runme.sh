...
HD_PWD='/home/alex/GitHub/lepton-core/rtl/xilinx/ultra96.runs/design_1_spi_master_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_spi_master_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_spi_master_0_0.tcl
