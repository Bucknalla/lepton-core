...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports sysclk] [get_bd_pins ila_0/clk] [get_bd_pins spi_master_0/clk]
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins spi_master_0/rst_n]
  ...
  connect_bd_net -net spi_master_0_spi_clk [get_bd_ports spi_clk_0] [get_bd_pins ila_0/probe6] [get_bd_pins spi_master_0/spi_clk]
  connect_bd_net -net spi_master_0_spi_cs [get_bd_ports spi_cs_0] [get_bd_pins ila_0/probe5] [get_bd_pins spi_master_0/spi_cs]
  connect_bd_net -net spi_miso_0_1 [get_bd_ports spi_miso_0] [get_bd_pins ila_0/probe4] [get_bd_pins spi_master_0/spi_miso]
