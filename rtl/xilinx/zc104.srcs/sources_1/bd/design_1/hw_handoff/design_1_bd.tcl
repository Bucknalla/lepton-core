...
proc create_root_design { parentCell } {
  ...
  # Create instance: lepton_vospi_0, and set properties
  set block_name lepton_vospi
  set block_cell_name lepton_vospi_0
  if { [catch {set lepton_vospi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $lepton_vospi_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net lepton_vospi_0_axis_m [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins lepton_vospi_0/axis_m]
  ...
  connect_bd_net -net Net [get_bd_pins ila_0/probe10] [get_bd_pins lepton_vospi_0/axis_m_tready] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins ila_0/probe3] [get_bd_pins lepton_vospi_0/axis_m_rst] [get_bd_pins lepton_vospi_0/rst]
  connect_bd_net -net lepton_if_0_sclk [get_bd_ports sclk] [get_bd_pins ila_0/probe0] [get_bd_pins lepton_vospi_0/spi_clk]
  connect_bd_net -net lepton_if_0_ss [get_bd_ports cs] [get_bd_pins ila_0/probe1] [get_bd_pins lepton_vospi_0/spi_cs]
  connect_bd_net -net lepton_vospi_0_axis_m_tdata [get_bd_pins ila_0/probe9] [get_bd_pins lepton_vospi_0/axis_m_tdata]
  connect_bd_net -net lepton_vospi_0_axis_m_tlast [get_bd_pins ila_0/probe4] [get_bd_pins lepton_vospi_0/axis_m_tlast]
  connect_bd_net -net lepton_vospi_0_axis_m_tuser [get_bd_pins ila_0/probe5] [get_bd_pins lepton_vospi_0/axis_m_tuser]
  connect_bd_net -net lepton_vospi_0_axis_m_tvalid [get_bd_pins ila_0/probe8] [get_bd_pins lepton_vospi_0/axis_m_tvalid]
  connect_bd_net -net lepton_vospi_0_current_state_wire [get_bd_pins ila_0/probe12] [get_bd_pins lepton_vospi_0/current_state_wire]
  connect_bd_net -net lepton_vospi_0_line_out [get_bd_pins ila_0/probe6] [get_bd_pins lepton_vospi_0/line_out]
  connect_bd_net -net lepton_vospi_0_line_val [get_bd_pins ila_0/probe11] [get_bd_pins lepton_vospi_0/line_val]
  connect_bd_net -net lepton_vospi_0_mode [get_bd_pins ila_0/probe14] [get_bd_pins lepton_vospi_0/mode]
  connect_bd_net -net lepton_vospi_0_seg_num [get_bd_pins ila_0/probe7] [get_bd_pins lepton_vospi_0/seg_num]
  connect_bd_net -net lepton_vospi_0_shift_reg_wire [get_bd_pins ila_0/probe13] [get_bd_pins lepton_vospi_0/shift_reg_wire]
  connect_bd_net -net miso_0_1 [get_bd_ports miso] [get_bd_pins ila_0/probe2] [get_bd_pins lepton_vospi_0/spi_miso]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins lepton_vospi_0/ctrl] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins lepton_vospi_0/axis_m_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins lepton_vospi_0/clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
