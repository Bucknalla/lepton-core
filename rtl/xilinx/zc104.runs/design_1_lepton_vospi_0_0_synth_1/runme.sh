...
HD_PWD='/home/alex/GitHub/lepton-core/rtl/xilinx/zc104.runs/design_1_lepton_vospi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_lepton_vospi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_lepton_vospi_0_0.tcl
